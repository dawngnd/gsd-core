...
- [x] **Phase 5: Planning Bridge** - Adapt approved NDD changes into GSD planning mechanics. (completed 2026-07-09)
- [x] **Phase 6: Execution Bridge** - Reuse GSD execution/subagent mechanics while preserving NDD traceability. (completed 2026-07-09)
- [x] **Phase 7: Verification, Ship, and Hardening** - Verify against `CHANGE-SPEC.md`, enrich ship output, and cover the NDD workflow with tests. (completed 2026-07-09)
...
- [x] 05-01: Define bridge model from NDD change artifact to GSD phase/planning context.
- [x] 05-02: Implement `ndd-plan-phase` wrapper/adaptor workflow.
- [x] 05-03: Add regression tests for approved-spec gating and phase-link metadata.
...
- [x] 06-01: Implement execution wrapper that loads NDD phase-link metadata and routes to GSD execution mechanics.

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 06-02: Add traceability/status updates and tests for execution handoff.
...
- [x] 07-01: Implement verification wrapper targeting `CHANGE-SPEC.md`.

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 07-02: Implement ship wrapper and PR context enrichment.

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 07-03: Add lifecycle documentation, command reference updates, and end-to-end workflow tests.
...
| 5. Planning Bridge | 3/3 | Complete    | 2026-07-09 |
| 6. Execution Bridge | 2/2 | Complete    | 2026-07-09 |
| 7. Verification, Ship, and Hardening | 3/3 | Complete    | 2026-07-09 |
